...
class SqueezeBodyEdge(nn.Module):
    def __init__(self, inplane, norm_layer=torch.nn.BatchNorm2d):
        """
        ...
        self.refine = nn.Conv2d(inplane *2,inplane,kernel_size=1)
    ...
    def forward(self, x):
        ...
        x_attention = self.refine(torch.cat([x,seg_edge],dim=1))
        return x_attention
